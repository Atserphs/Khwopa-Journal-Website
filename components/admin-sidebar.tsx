        ...
        <div className="flex flex-col h-full">
          <div className="flex items-center justify-between p-4 border-b">
            <Link href="/admin" className="flex items-center">
              ...
              {!isCollapsed && <span className="ml-2 font-bold text-xl">Admin Panel</span>}
            </Link>
          ...
          <div className="flex-1 py-6 overflow-y-auto">
            <nav className="px-2 space-y-1">
              ...
              <div className={`mt-6 mb-2 px-3 ${isCollapsed ? "text-center" : ""}`}>
              ...
              <NavItem
                ...
                isCollapsed={isCollapsed}
              />
              <NavItem href="/" icon={<Home className="h-5 w-5" />} text="View Website" isCollapsed={isCollapsed} />
            </nav>
          </div>
            ...
            <div className={`flex ${isCollapsed ? "justify-center" : "items-center"}`}>
              {!isCollapsed && (
                <div className="mr-3">
                  ...
                  <p className="text-xs text-gray-500">admin@journal.com</p>
                </div>
              )}
  ...
  return (
    <Link
      ...
      className={`flex items-center px-3 py-2 text-gray-700 rounded-md hover:bg-gray-100 hover:text-blue-700 transition-colors
        ${href === "/admin" ? "bg-blue-50 text-blue-700" : ""}
